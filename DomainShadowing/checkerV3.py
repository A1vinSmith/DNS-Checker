...
def detect_domain_shadowing(target_domain, subdomains_file):
    # Fetch subdomains from crt.sh with caching
    ...
    try:
        with open(subdomains_file, 'r') as file:
            additional_subdomains = {line.strip() for line in file}
...
if __name__ == "__main__":
    ...
    detect_domain_shadowing(args.target_domain, args.subdomains_file)
